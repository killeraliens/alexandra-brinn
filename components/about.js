    ...
    return `
         <section id="aboutSection" class="container">
          <div class="">
              ...
              <p>
                This includes user-flow illustration, HTML/CSS/JavaScript wireframing, React SPAs, and REST API development using Node.js, Express, and PostgreSQL.
              </p>
              <p>
              ...
              <p>
                For me, coding is not just a potential job. It is a medium I want to specialize in to create great products with intrinsic value.
